...
export CBR__CUSTOM__PACKAGES_TO_INSTALL='["cbr_website_beta", "cbr_static"]'
export S3_DEV__BUCKET="654654216424--cbr-deploy--eu-west-1"
export S3_DEV__PARENT_FOLDER="cbr-custom-websites"
export S3_DEV__VERSION='custom-version__cbr_community'
export CBR__CUSTOM__VERSION_FILE=$S3_DEV__VERSION
export CBR__CUSTOM__LAMBDA_NAME="custom-version__cbr_community"
